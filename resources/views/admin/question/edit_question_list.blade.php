...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body>
                  ...
                  <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                      <div class="card" style="background-color: #fff;">
                        <div class="card-body">
                          <h4 class="card-title text-dark">Edit Question Form</h4>
                          @if ($errors->any())
                          ...
                          <form role="form" class="forms-sample" action="{{url('admin/edit_questions_list/'.$edit_question_id->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                          ...
                          <div class="form-group row">
                            <label for="exampleInputUsername2" class="col-sm-3 col-form-label h2 text-dark" style="padding-left: 10px">Question Name <span style="color:red;">&nbsp;*</span></label>
                            <div class="col-sm-9">
                              <input type="text" multiple class="form-select bg-outline-dark border-3"  value="{{$edit_question_id->question_name}}" name="QuestionName" id="QuestionName" placeholder="Enter a Question name">
                            </div>
                          </div>
                          <div id ='normal' class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea multiple id="ShortNormal" class="form-select bg-light focus text-dark-50 bg-outline-dark border-3" name="ShortNormal" id="ShortNormal" placeholder="Enter a short Question Description" rows="3">{{$edit_question_id->question_short_description }}</textarea>                              </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div id ='Normal' class="form-group row">
                            <label for="normal_desc" class="col-sm-3 col-form-label h2 text-dark" style="padding-left: 10px">Question Description <span style="color:red;">&nbsp;*</span></label>
                            <div class="col-sm-9">
                              <textarea multiple class="form-select bg-outline-dark border-3" id="normal_desc" name="ques_desc_1" placeholder="Enter a Question Description" rows="10">@if($edit_question_id->question_type == 1){{$edit_question_id->question_description}}@endif</textarea>
                            </div>
                          </div>
                          <div id="form-text" class="form-group row">
                            <label for="ques_desc_2" class="col-sm-3 col-form-label h2 text-dark" style="padding-left: 10px">Question HTML Description <span style="color:red;">&nbsp;*</span></label>
                            <div class="col-sm-9">
                              <textarea class="form-control" id="html_desc" name="ques_desc_2" rows="8">@if($edit_question_id->question_type == 2){{$edit_question_id->question_description}}@endif</textarea>
                            </div>
                          </div>
                          <div class="form-group row">
                            <label for="" class="col-sm-3 col-form-label h2 text-dark" style="padding-left: 10px">Image Type<span style="color:red;">&nbsp;*</span></label>
                            <div class="col-sm-9">
                              <div class="form-check-inline h5 text-dark">
                          ...
                          <div id ='Normal_image_type' class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                              <input type="File" multiple class="form-select bg-outline-dark border-3 file" id="file" name="file" placeholder="Choose File">
                            </div>
                          </div>
                          <div id="url_image_type" class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" multiple class="form-select bg-outline-dark border-3" id="file_1" name="url_image" value="@if($edit_question_id->image_type == 2){{$edit_question_id->question_image}}@endif" placeholder="Copy and past a URL">
                            </div>
                          </div>
    ...
    <script>
      var aa = {{$edit_question_id->question_type ?? 1}};
      test_check(aa);
