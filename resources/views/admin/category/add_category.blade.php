              ...
              <div class="content-wrapper cc">
                @php $filename = basename($_SERVER['PHP_SELF']); @endphp         
                  <nav aria-label="breadcrumb">
                      <div class="btn-group">             
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page"><a href="{{url('admin/category_list')}}">List of Category table</a></li>
                  ...
                  <div class="row">
                    <div class="col-md-12 grid-margin stretch-card">
                      <div class="card" style="background-color: #fff;">
                        <div class="card-body"> 
                          <h4 class="card-title text-dark">Category Form</h4> 
                          @if ($errors->any())
                          ...
                          @endif       
                          <hr class="text-dark">
                          <form class="forms-sample" action="{{url('admin/category.insert')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                              <label for="exampleInputUsername2" class="col-sm-3 col-form-label h2 text-dark" style="padding-left: 10px">Category Name <span style="color:red;">&nbsp;*</span></label>
                              <div class="col-sm-9">
                                <input type="text" multiple class="form-select bg-outline-dark border-3"  name="category_name" id="exampleInputUsername2" placeholder="Enter a Category name">
                              </div>
                            </div>
                            <div class="form-group row">
                              <label for="exampleInputEmail2" class="col-sm-3 col-form-label h2 text-dark" style="padding-left: 10px">Category Description <span style="color:red;">&nbsp;*</span></label>
                              <div class="col-sm-9">
                                <textarea multiple class="form-select bg-outline-dark border-3"  name="category_description" id="exampleInputEmail2" placeholder="Enter a Category Description" rows="6"></textarea>
                              </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input class="form-check-input" type="checkbox" name="filecheck" value="1" id="flexCheckDefault">
                                  <label class="form-check-label text-dark" for="flexCheckDefault">
                                  File Enable</label>
                              </div>
                            </div> 
                            <div class="form-group row" id="csvfile">
                              {{-- <label for="count" class="col-sm-3 col-form-label h2 text-dark" style="padding-left: 10px">letters Count<span style="color:red;">&nbsp;*</span></label>
                              <div class="col-sm-9">
                                <input multiple class="form-select bg-outline-dark border-3" type='text' id="count" name='count' placeholder="Enter the letters count">
                              </div>
                              <br>
                              <br>
                              <br> --}}
                          ...
                          <br>
                          <form  class="forms-sample"  method='post' action='{{url('admin/uploadFile')}}' enctype='multipart/form-data' >
                            {{ csrf_field() }}
                  ...
                  {{-- <script type="text/javascript">
                      ...
                      {
                          var name = $('#exampleInputUsername3').val();
                          var message = $('#exampleInputEmail3').val();
                          if(name.trim() == '' )
                          {
                              $('#exampleInputUsername3').val('');
                              $('.statusMsg1').html('<span style="color:red;">Some problem occurred, please fill the Category name.</span>');
                              // return false;
                          }
                          if(message.trim() == '' )
                          {
                              $('#exampleInputEmail3').val('');
                              $('.statusMsg2').html('<span style="color:red;">Some problem occurred, please fill the category description.</span>');
                              // return false;
                          }
                          else
                          {
                              ...
                              $.ajax({
                                  ...
                                  success:function(msg)
                                  {
                                    if(msg == 'ok')
                                    {
                                        $('#exampleInputUsername3').val('');
                                        $('#exampleInputEmail3').val('');
                                        $('.msg1').html('<span style="color:green;">Category Added successfully.</p>');
                                    }
                                    else
                                    {
