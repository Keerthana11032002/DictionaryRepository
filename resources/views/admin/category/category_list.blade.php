                        ...
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-md-3" style="padding-left:70px;">
                              <a class="nav-link btn btn-success create-new-button" href="{{url('admin/add_category')}}">+ Create New Category</a>
                            </div>
                          </div>
                          {{-- <p class="card-description h5 text-dark"> List of Category Tables </p> --}}
                          <p class="card-title h5 text-dark" style="padding-right: 40px">Total Categories : {{count($categorys)}}</p>
                            ...
                            <table id="members_list" class="table table-bordered border-0 bg-light">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col text-dark"> <strong>Category Description </strong></th>
                                  <th scope="col text-dark"> <strong>Category Image</strong></th>
                              ...
                              <tbody>
                                ...
                                @foreach($categorys as $category)
                                  <tr>
                                    <td class="text-dark focus">{{$sno}}</td>
                                    <td class="text-dark focus">{{$category->category_name}}</td>
                                    <td class="text-dark text-center focus">{{$category->category_description}}</td>
                                    <td class="text-dark focus d-flex justify-content-center">
                                      ...
                                      @elseif($category->image_type == 1)
                                        <center><img  src="{{asset('storage/'.$category->category_image ) }}"  style="height:50px; width:auto;border-radius:70%;"></center>
                                      @else
                                      <center><img  src="{{$category->category_image}}" style="height:60px; width:70px;border-radius:50%;"></center>
                                      @endif
                                    </td>
                                    <td>
                                      <div class="btn-group" role="group">
                                        <form action={{url("admin/edit_category/".$category->id)}} method="POST">
                                          {{csrf_field()}}
                                          <button type="submit" class="btn-sm btn-primary border-0" style="min-height: 15%" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit App"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16"><path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                                            </svg></button>
                                        </form>
                                        <form action={{url("admin/delete_category/".$category->id)}} method="POST" style="padding-left:5px;">
                                          {{csrf_field()}}
                                            <button type="submit" class="btn-sm btn-danger border-0" onclick="return confirm('Are you sure you want to delete this item?');" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete App"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
                                    ...
                                    <style>
                                      ...
                                      <td>
                                        <form action="{{url('admin/category_status_update')}}" method="POST">
                                          @csrf
